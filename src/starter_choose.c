...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_ROCKRUFF)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_EEVEE   )
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_PIKACHU )
